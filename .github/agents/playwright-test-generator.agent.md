...
**Quality Standard:** Tests must be developed and executed incrementally. Each test must run, succeed, and be verified immediately upon creation. If a test fails, it must be resolved completely before generating or proceeding to the next test in the plan.
